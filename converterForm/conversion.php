...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (isset($_POST["degree"])) {
    ...
    if ($degree != null && is_numeric($degree)) {
      // making sure degree value is filled and numeric
      $temperature_form->generateOutput($original, $desired, $degree); // call on converter handler method to perform the appropriate operation for the form data
    }
    // end inner if
